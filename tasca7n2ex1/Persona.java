...
@JsonSerializable(ruta = ".//src//tasca7n2ex1//FitxerJson.json") // (ruta = "novaRuta") si no faig això agafarà la
...
public class Persona {
	...
	private String address; // aquesta no s'afegeix al serializable Json pq no te anotació JElement
